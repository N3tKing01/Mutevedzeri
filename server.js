...
const BOT_NAME = process.env.BOT_NAME || "BREAL - MD";
const OWNER_NAME = process.env.OWNER_NAME || "MIDKBAN-TECH";

const MENU_IMAGE_URL = process.env.MENU_IMAGE_URL || "https://graph.org/file/75ab6998ad096f6df326e-91a5a6e2ea3f980c00.jpg";
...
const AUTO_STATUS_MSG = process.env.AUTO_STATUS_MSG || "YOUR STATUS HAS BEEN SEEN BY BREAL - MD 💜";
const DEV = process.env.DEV || 'MIDKBAN-TECH';
            ...
            case 'sunset':
                ...
                await conn.sendMessage(from, {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterName: "BREAL - MD",
                        serverMessageId: 200
                    },
                        externalAdReply: {
                            title: "📃 BREAL Command Menu",
